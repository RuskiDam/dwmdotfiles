...
static const char *fonts[]          = {"JetBrainsMono:style:medium:size=16" ,"JetBrainsMono:style:medium:size=19" };
...
static const Key keys[] = {
    ...
    // kill dwm
    { MODKEY|ControlMask,               XK_p,       spawn,        SHCMD("killall bar.sh chadwm") },
